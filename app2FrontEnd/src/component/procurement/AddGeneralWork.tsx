                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select {...register('work_type', { required: true })} className="w-full h-12 px-4 rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:border-blue-500 transition-all font-bold shadow-sm ring-0 outline-none">
                                ...
                                <option value="Traveau supplementaire">Traveau supplementaire</option>
                                ...
                                <Controller
                                    ...
                                    render={({ field: { onChange, value, ...rest } }) => (
                                        <input
                                            ...
                                            placeholder="0,00"
                                            className="w-full pl-12 pr-4 h-12 rounded-xl border-blue-100 font-black text-blue-700 text-lg shadow-inner focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                                        />
                                    )}
                                />
                            </div>
