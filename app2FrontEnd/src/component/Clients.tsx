            ...
            <div className="bg-white/70 backdrop-blur-xl p-8 rounded-[32px] border border-white shadow-[0_20px_50px_rgba(0,0,0,0.04)] space-y-6">
                <div className="flex flex-wrap items-center justify-between gap-6">
                    <div>
                        ...
                        <p className="text-slate-500 font-medium text-sm mt-1">Dossiers clients, situation financière and documents de <span className="text-slate-800 font-bold">EL OUAHA</span>.</p>
                    </div>
